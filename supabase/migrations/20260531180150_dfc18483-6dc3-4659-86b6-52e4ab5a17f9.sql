...
CREATE FUNCTION public.get_daily_stats()
 RETURNS TABLE(day date, visitors bigint, bio_clicks bigint, bio_redirects bigint, podcast_redirects bigint)
 LANGUAGE sql
...
CREATE FUNCTION public.get_hourly_stats_today()
 RETURNS TABLE(hour timestamp with time zone, visitors bigint, bio_clicks bigint, bio_redirects bigint, podcast_redirects bigint)
 LANGUAGE sql
 STABLE SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
