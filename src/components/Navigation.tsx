        ...
        <div className="flex items-center h-16 gap-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden sm:flex items-center gap-2 pl-2">
              ...
              >
                <Instagram className="w-4 h-4 text-neutral-800 hover:text-primary transition-colors" />
              </a>
              <a 
              ...
              >
                <svg className="w-4 h-4 text-neutral-800 hover:text-primary transition-colors" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                <Youtube className="w-4 h-4 text-neutral-800 hover:text-primary transition-colors" />
              </a>
              <a 
              ...
              >
                <Facebook className="w-4 h-4 text-neutral-800 hover:text-primary transition-colors" />
              </a>
              <a 
