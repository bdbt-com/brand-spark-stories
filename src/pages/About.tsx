                  ...
                  <CollapsibleTrigger asChild>
                    <div className="relative">
                      ...
                      <div className="absolute inset-1">
                        <div className="absolute inset-0 rounded-2xl border-1 border-blue-400/50 animate-ping" style={{ animationDuration: '2s', animationIterationCount: 'infinite' }}></div>
                      </div>
                      <div className="absolute inset-2">
                        <div className="absolute inset-0 rounded-2xl border-1 border-blue-500/50 animate-ping" style={{ animationDuration: '2s', animationDelay: '0.7s', animationIterationCount: 'infinite' }}></div>
                      </div>
                      <div className="absolute inset-3">
                        <div className="absolute inset-0 rounded-2xl border-1 border-blue-600/50 animate-ping" style={{ animationDuration: '2s', animationDelay: '1.4s', animationIterationCount: 'infinite' }}></div>
                      </div>
                      
                      {/* Enhanced Glow Effect - Ocean Blue with 50% Transparency */}
                      <div className="absolute inset-1 bg-blue-500/10 rounded-2xl animate-pulse" style={{ animationDuration: '3s' }}></div>
            ...
            <CollapsibleContent className="mt-16">
              <div className="max-w-7xl mx-auto relative">
                ...
                <div className="hidden lg:block absolute left-0 top-0 w-36 space-y-8">
                  ...
                  {/* Photo 3 - Mid Left */}
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "1200ms", marginTop: "2000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
                  ...
                  {/* Photo 5 - Lower Left */}
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "1900ms", marginTop: "2000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
                  ...
                  {/* Photo 7 - Bottom Left */}
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "2600ms", marginTop: "2000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
                ...
                <div className="hidden lg:block absolute right-0 top-0 w-36 space-y-8">
                  {/* Photo 2 - Top Right */}
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "800ms", marginTop: "1000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
                  ...
                  {/* Photo 4 - Mid Right */}
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "1500ms", marginTop: "2000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
                  ...
                  {/* Photo 6 - Lower Right */}
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "2200ms", marginTop: "2000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
                  ...
                  <div className="w-30 h-30 bg-gradient-primary/10 border-2 border-primary/20 rounded-xl shadow-soft animate-fade-in" style={{ animationDelay: "2900ms", marginTop: "2000px" }}>
                    <div className="w-full h-full rounded-lg bg-muted/50 flex items-center justify-center">
                      <span className="text-sm text-muted-foreground">Photo</span>
                    </div>
                  </div>
