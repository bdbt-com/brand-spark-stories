          ...
          <article className="flex flex-col gap-3 sm:gap-5">
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
              <a
                ...
                className="group flex items-center justify-center gap-2 h-16 sm:h-20 rounded-2xl border border-border bg-card hover:bg-card/80 active:scale-[0.98] transition-all focus:outline-none focus:ring-2 focus:ring-primary touch-manipulation"
              ...
              <Link
                ...
                className="group flex items-center justify-center gap-2 h-16 sm:h-20 rounded-2xl border border-primary/40 bg-primary/10 hover:bg-primary/15 active:scale-[0.98] transition-all focus:outline-none focus:ring-2 focus:ring-primary touch-manipulation"
