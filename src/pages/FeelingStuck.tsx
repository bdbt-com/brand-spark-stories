...
const CollapsibleRow = ({ item, icon: Icon, iconColor }: { item: any, icon: any, iconColor: string }) => {
          ...
          <Card className="bg-primary text-white shadow-strong">
            <CardContent className="p-8">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="bg-white text-primary hover:bg-gray-100 border-white font-semibold"
                asChild
              >
