...
Stuck looks different for everyone. For some it's constant tiredness, aches and pains, or struggling with sleep. 


For others it's money stress, debt, or never quite getting ahead. And for many, it's internal; a lack of purpose, strained relationships, or the sense that you're just going through the motions.</p>
            <p>
...
But here's the truth: you don't need a dramatic leap to escape feeling stuck.</p>
            <p className="text-xl font-semibold text-primary">
      ...
      {/* Where People Feel Stuck Section */}
