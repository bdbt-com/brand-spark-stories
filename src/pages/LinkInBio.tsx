        ...
        <div className="w-full mt-3 md:mt-8">
          ...
          >
            {podcastEpisodes.map((episode, index) => (
              <div 
                key={episode.videoId} 
                className={`group transition-all duration-300 className={`group transition-all duration-300 w-[40vw] min-w-[40vw] max-w-[40vw] md:w-auto md:min-w-0 md:max-w-none snap-center flex-shrink-0 ${episode.videoId === 'OjwSKAXveN8' ? 'md:scale-110 md:z-10' : ''}`} md:w-auto md:min-w-0 md:max-w-none snap-center flex-shrink-0 ${episode.videoId === 'OjwSKAXveN8' ? 'md:scale-110 md:z-10' : ''}`}
              >
