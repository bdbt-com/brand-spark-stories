  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-primary/90 to-primary/80">
      ...
      <div className="flex items-center justify-center min-h-screen p-8">
        ...
        {/* Podcast 93 - Set an Hourly Reminder to Stand Up */}
        {currentTemplateIndex === 110 && mode === 'instagram' && (
          <div className="flex justify-center">
            <TikTokTemplate templateIndex={110} />
          </div>
        )}

        {currentTemplateIndex === 97 && mode === 'youtube' && (
          <div className="flex justify-center">
            <div id="thumbnail-97" key="template-97" className="w-[1280px] h-[720px] relative overflow-hidden bg-gradient-to-br from-primary via-primary/90 to-primary/80 shadow-2xl animate-fade-in border-2 border-white">
              <div className="h-full flex items-center p-16 relative">
                <div className="absolute right-16 top-16 bottom-16 flex items-center">
                  <div className="w-[650px] h-[650px] bg-white/10 backdrop-blur-md rounded-2xl border-2 border-white/30 shadow-xl overflow-hidden relative">
                    <img src="/lovable-uploads/bc6fa209-b818-463e-aeb6-08d6c7b423c6.png" alt="Podcast thumbnail" className="w-full h-full object-cover border-4 border-white/20" />
                ...
                <div className="absolute left-8 top-16 bottom-24 right-[35%] pr-4 z-10 flex flex-col justify-center">
                  <h1 className="text-6xl xl:text-7xl 2xl:text-8xl font-bold leading-tight mb-6">
                    <span className="text-white block mb-2">Set an Hourly Reminder</span>
                    <span className="block" style={{ color: 'hsl(35, 45%, 75%)' }}>to Stand Up</span>
                  </h1>
                  <p className="text-white/80 text-3xl font-medium">Daily Wins Podcast 93</p>
                </div>
              </div>
            </div>
          </div>
